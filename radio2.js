...
const PASTAS = {
  ...
  baladavibe: {
    ...
    "https://audio.jukehost.co.uk/019ef472-cd1f-734f-a621-2d12359734b4",
  ...
  fundaovibe: {
   ...
   "https://audio.jukehost.co.uk/019ef657-4e79-7145-b2f5-42b8299aaee2",
  ...
  grove: {
    ...
    "https://audio.jukehost.co.uk/019f005c-b702-73de-bb39-4a20c2102ef6",
...
function getPastaInicialPorHorario() {
  ...
  // Ajuste pedido:
  // - Domingo: rootsvibe 21h até 00h (na prática: 21h-23:59)
  // - Segunda a sexta: rootsvibe 18h-19h
  // - Segunda a sexta: baladavibe 19h-02h

  // Domingo 21h-23:59 => rootsvibe
  if (day === 0 && h >= 21 && h <= 23) {
    return "rootsvibe";
  }
